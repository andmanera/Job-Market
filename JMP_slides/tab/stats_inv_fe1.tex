...
\makebox[\linewidth][c]{
	\begin{tabular}{lHcH*{2}{c}}
\hline\hline
                    & $\Delta$ 90/50 Quantile  & $\Delta$ Top 10\%/Bottom 50\%  &$\Delta$ Top 50/\% Bottom-50\% & $\Delta$ Top 10\%& $\Delta$ Bottom 50\% \\
                    &\multicolumn{1}{H}{(1)}   &\multicolumn{1}{c}{(2)}   &\multicolumn{1}{H}{(3)}   &\multicolumn{1}{c}{(4)}   &\multicolumn{1}{c}{(5)}   \\
\hline
$\Delta \underline{HHI}$ &       0.211+  &       0.243*  &       0.314+  &       0.018** &      -0.008*  \\
