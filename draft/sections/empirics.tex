...
\begin{centering}
\includegraphics[width=0.9\textwidth]{\string"/Users/andreamanera/Dropbox (MIT)/Research/ProductInnovation/docs/JMP/draft/graphs/Kmarkets/Kmarkets.006\string".png}\\
\par\end{centering}
...
As noted above, these markets are identifies using my measure of effective
inventors, but I assess the robustness of this procedure to using
raw counts of inventor transitions. When applying the procedure to
4-digit NAICS sectors, I find that over 97\% of the pairs of NAICS
sectors are classified in the same manner using the two measures.
That is, 97\% of sector pairs belong to the same knowledge market
according to both measures, and they do not belong to the same market
if they do not according to either measure.

\begin{figure}[t]
\caption{Knowledge Markets Obtained from NAICS 3-digit Sectors}
\label{fig: KmarketGraph-1}
\begin{centering}
\includegraphics[width=0.9\textwidth]{\string"/Users/andreamanera/Dropbox (MIT)/Research/ProductInnovation/docs/JMP/draft/graphs/NewCommunity_3d\string".png}\\
\par\end{centering}
...
\begin{centering}
\scalebox{.9}{\input{../tab/Dk4_sh_inv_hhi_noctrl_inv_fe1.tex}}\\
\par\end{centering}
...
\par\end{centering}
\centering{}\scalebox{.9}{\input{../tab/Dk4_sh_inv_hhi_inv_fe1.tex}}}
\par\end{centering}

\begin{centering}
\subfloat[Controlling for Change in Log Real Sales per Company]{\centering{}\scalebox{.9}{ \input{../tab/Dk4_sh_inv_hhi_pc_inv_fe1.tex}}}\\
\par\end{centering}
\raggedright{}{\small{}Note: Regressions weighted by sales in 2012;
Robust standard errors in parentheses; Symbols denote significance
levels $\left(+\ p<0.1,^{*}\ p<0.05,^{**}\ p<.01,^{***}\ p<.001\right)$;
...
\subfloat[Raw Scatter Plot, Specification in Column (2)]{\centering{}\includegraphics[width=0.9\textwidth]{\string"/Users/andreamanera/Dropbox (MIT)/Research/ProductInnovation/docs/JMP/draft/graphs/raw_Dk4_hhi_inv_fe10\string".pdf}}

\subfloat[Binned Scatter Plot, Specification in Column (6)]{\centering{}\includegraphics[width=0.9\textwidth]{\string"/Users/andreamanera/Dropbox (MIT)/Research/ProductInnovation/docs/JMP/draft/graphs/bin_Dk4_hhi_inv_fe12\string".pdf}}\\
...
\centering{}\scalebox{.9}{\input{../tab/IV_inv_fe1.tex}}}\\
\subfloat[First Stage and Reduced Form]{
\centering{}\scalebox{1}{\input{../tab/IV_first_inv_fe1.tex}}}\\
\par\end{centering}
\raggedright{}{\small{}Note: Regressions weighted by sales in 2012;
Robust standard errors in parentheses; Symbols denote significance
levels $\left(+\ p<0.1,^{*}\ p<0.05,^{**}\ p<.01,^{***}\ p<.001\right)$;
...
\begin{centering}
\scalebox{1}{\input{../tab/stats_inv_fe1.tex}}\\
\par\end{centering}
\raggedright{}{\small{}Note: Regressions weighted by sales in 2012;
Robust standard errors in parentheses; Symbols denote significance
levels $\left(+\ p<0.1,^{*}\ p<0.05,^{**}\ p<.01,^{***}\ p<.001\right)$;
...
\par\end{centering}
\centering{}\scalebox{.9}{\input{../tab/fwd_cite_all_inv_fe1.tex}}}
\par\end{centering}

\begin{centering}
\subfloat[Full sample, restricting to the middle range of the change in inventor
shares ($-2\%$ to $+2\%$)]{\centering{}\scalebox{.9}{ \input{../tab/fwd_cite_mid_inv_fe1.tex}}}\\
\par\end{centering}
...
\begin{centering}
\scalebox{.9}{\input{../tab/self_cite_all_inv_fe1.tex}}
\par\end{centering}
\begin{centering}
\par\end{centering}
\raggedright{}{\small{}Note: Unweighted regressions; Robust standard
...
\centering{}\scalebox{.95}{\input{../tab/Lprod_inv_fe1.tex}}}\\
